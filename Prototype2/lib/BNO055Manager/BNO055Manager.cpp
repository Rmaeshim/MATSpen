...
{
    x_ang_vel_container.reset();
    y_ang_vel_container.reset();
    z_ang_vel_container.reset();
}
...
void updateIMU() {
    ...
    if (new_ex != ex) {
        ...
        x_ang_vel = x_ang_vel_container.computeAvg(ex * PI / 180.0);
        Serial.print("\tvz");
        Serial.print(x_ang_vel, 4);

        Serial.print("\thz");
        Serial.print(x_ang_vel_container.getFrequency(), 4);
    }
    ...
    if (new_ey != ey) {
        ...
        y_ang_vel = y_ang_vel_container.computeAvg(ey * PI / 180.0);
        Serial.print("\tvy");
        Serial.print(y_ang_vel, 4);

        Serial.print("\thy");
        Serial.print(y_ang_vel_container.getFrequency(), 4);
    }
    ...
    if (new_ez != ez) {
        ...
        z_ang_vel = z_ang_vel_container.computeAvg(ez * PI / 180.0);
        Serial.print("\tvx");
        Serial.print(z_ang_vel, 4);

        Serial.print("\thx");
        Serial.print(z_ang_vel_container.getFrequency(), 4);
    }
