...
TB6612::TB6612(double counts_per_rotation, double gear_ratio, double max_speed, double Kp, double Ki, double Kd)
{
    this->Kp = Kp;
    this->Ki = Ki;
    this->Kd = Kd;
...
TB6612::TB6612(double counts_per_rotation, double gear_ratio, double max_speed) {
    TB6612(counts_per_rotation, gear_ratio, max_speed, 1.0, 0.0, 0.0);
}
...
void TB6612::setMotorRaw(int speed)
{
    ...
    analogWrite(TB6612_PWM_MOTOR_PIN_A, speed);
}
